...
library(docknitr)
docknitr::docker_alias("pyseer.bash", image="pyseer", command="bash", share.files=TRUE)
docknitr::docker_alias("pyseer.python", image="pyseer", command="/conda/bin/python3.7", share.files=TRUE)
```
